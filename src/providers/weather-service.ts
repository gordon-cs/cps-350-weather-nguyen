...
export class WeatherService {
    ...
    private _currentTemperature : Observable<any>; //got "any" from demo code
    ...
    constructor(public http: HttpClient) { 
        ...
        this.http.jsonp(this.realUrl, 'callback').subscribe(data => { this._currentBehavior.next(data.currently.temperature);},
